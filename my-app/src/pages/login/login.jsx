...
const Login = () => {
    ...
    return ( 
        <form onSubmit={handleSubmit} className="form d-flex flex-column align-items-center">
            ...
            <input className="username mt-4" type="text" placeholder="Username" name="username" value={account.username} onChange={handleInput} />
            <input className="password" type="password" placeholder="Password" value={account.password} name="password" onChange={handleInput} />
